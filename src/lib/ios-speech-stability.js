...
function installIOSSpeechStability() {
  if (!isIOSDevice()) return;
  const synthesis = window.speechSynthesis;
  if (!synthesis || synthesis.__mayfitIOSSpeechStability) return;
  ...
  try {
    Object.defineProperty(synthesis, "__mayfitIOSSpeechStability", {
      configurable: false,
      value: true,
    });
  } catch {}
