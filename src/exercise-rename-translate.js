...
Object.assign(translations,{
  'Ankle Circles':'Círculos com os tornozelos','Anterior Tibialis-SMR':'Liberação do tibial anterior','Atlas Stone Trainer':'Treino com pedra Atlas','Atlas Stones':'Pedras Atlas',
  'Battling Ropes':'Cordas navais','Bicycling':'Pedalada','Bicycling, Stationary':'Bicicleta ergométrica','Brachialis-SMR':'Liberação do braquial','Butt-Ups':'Elevação do quadril',
  'Butterfly':'Borboleta','Car Drivers':'Giro com anilha','Child\'s Pose':'Postura da criança','Circus Bell':'Halter circense','Cocoons':'Abdominal casulo','Conan\'s Wheel':'Roda de Conan',
  'Crucifix':'Crucifixo','Dead Bug':'Abdominal inseto morto','Elliptical Trainer':'Elíptico','Farmer\'s Walk':'Caminhada do fazendeiro','Fast Skipping':'Salto rápido',
  'Flutter Kicks':'Tesoura abdominal','Foot-SMR':'Liberação dos pés','Gironda Sternum Chins':'Barra Gironda no esterno','Good Morning':'Bom dia','Good Morning off Pins':'Bom dia partindo dos pinos',
  'Groiners':'Alongamento dinâmico da virilha','Heavy Bag Thrust':'Empurrada de saco pesado','Iliotibial Tract-SMR':'Liberação do trato iliotibial','Inchworm':'Caminhada com as mãos',
  'Iron Cross':'Cruz de ferro','Jogging, Treadmill':'Trote na esteira','Keg Load':'Levantamento de barril','Kettlebell Figure 8':'Kettlebell em oito','Kettlebell Pirate Ships':'Navio pirata com kettlebell',
  'Kettlebell Thruster':'Agachamento e desenvolvimento com kettlebell','Kettlebell Windmill':'Moinho com kettlebell','Landmine 180\'s':'Rotação 180° na landmine',
  'Landmine Linear Jammer':'Empurrada linear na landmine','Lateral Bound':'Salto lateral','Latissimus Dorsi-SMR':'Liberação do grande dorsal','Leg Press':'Leg press',
  'Linear 3-Part Start Technique':'Técnica de largada linear em 3 partes','London Bridges':'Ponte londrina','Looking At Ceiling':'Olhar para o teto','Monster Walk':'Caminhada monstro',
  'Mountain Climbers':'Escalador','Moving Claw Series':'Série garra em movimento','Peroneals-SMR':'Liberação dos fibulares','Piriformis-SMR':'Liberação do piriforme',
  'Prowler Sprint':'Corrida com trenó','Pyramid':'Pirâmide','Quick Leap':'Salto rápido','Rack Delivery':'Colocação no suporte','Rack Pulls':'Levantamento parcial no suporte',
  'Rhomboids-SMR':'Liberação dos romboides','Rickshaw Carry':'Caminhada com riquixá','Rowing, Stationary':'Remo ergométrico','Running, Treadmill':'Corrida na esteira',
  'Sandbag Load':'Levantamento de saco de areia','Skating':'Patinação','Spell Caster':'Giro com anilha','Spider Crawl':'Caminhada aranha','Stairmaster':'Simulador de escada',
  'Stomach Vacuum':'Vácuo abdominal','Superman':'Superman','Tire Flip':'Virada de pneu','Toe Touchers':'Toque nos pés','Walking, Treadmill':'Caminhada na esteira',
  'Wind Sprints':'Tiros de corrida','Windmills':'Moinhos','Yoke Walk':'Caminhada com jugo'
});

const phrases={'body weight':'peso corporal','close grip':'pegada fechada','wide grip':'pegada aberta','medium grip':'pegada média','overhead':'acima da cabeça','straight arm':'braço estendido','single arm':'um braço','one arm':'um braço','single leg':'uma perna','one leg':'uma perna','upper body':'parte superior do corpo','lower body':'parte inferior do corpo','range of motion':'amplitude de movimento','on the floor':'no chão','behind the neck':'atrás da nuca'};
const words={ab:'abdominal',adductor:'adutor',advanced:'avançado',alternate:'alternado',alternating:'alternado',arm:'braço',arms:'braços',back:'costas',backward:'para trás',balance:'equilíbrio',ball:'bola',band:'elástico',bands:'elásticos',bar:'barra',barbell:'barra',bench:'banco',bent:'inclinado',biceps:'bíceps',bike:'bicicleta',body:'corpo',bodyweight:'peso corporal',box:'caixa',bridge:'ponte',cable:'polia',calf:'panturrilha',calves:'panturrilhas',chair:'cadeira',chest:'peito',chin:'queixo',clean:'arremesso',close:'fechada',concentration:'concentrada',crossover:'cruzamento',crunch:'abdominal',crunches:'abdominais',curl:'rosca',curls:'roscas',deadlift:'levantamento terra',deadlifts:'levantamentos terra',decline:'declinado',delt:'deltoide',deltoid:'deltoide',dip:'mergulho',dips:'mergulhos',double:'duplo',down:'para baixo',dumbbell:'halteres',dynamic:'dinâmico',elbow:'cotovelo',elbows:'cotovelos',elevated:'elevado',extension:'extensão',extensions:'extensões',external:'externa',face:'rosto',flat:'reto',flexor:'flexor',floor:'chão',fly:'voador',flye:'voador',flyes:'voador',front:'frontal',glute:'glúteo',grip:'pegada',groin:'virilha',hammer:'martelo',hamstring:'posterior de coxa',hang:'suspenso',hanging:'suspenso',head:'cabeça',high:'alto',hip:'quadril',hips:'quadris',hops:'saltos',incline:'inclinado',inner:'interno',internal:'interna',isometric:'isométrico',jump:'salto',kick:'chute',kickback:'coice',knee:'joelho',kneeling:'ajoelhado',knees:'joelhos',lat:'dorsal',leg:'perna',legged:'perna',legs:'pernas',lift:'elevação',low:'baixo',lower:'inferior',lunge:'avanço',lying:'deitado',machine:'máquina',medicine:'medicinal',military:'militar',narrow:'estreita',neck:'pescoço',oblique:'oblíquo',open:'aberta',palms:'palmas',parallel:'paralelo',pelvic:'pélvica',plate:'anilha',plank:'prancha',power:'potência',preacher:'scott',press:'desenvolvimento',presses:'desenvolvimentos',prone:'pronado',pulldown:'puxada',pulldowns:'puxadas',pulley:'polia',pull:'puxada',pullover:'pulôver',push:'empurrada',pushdown:'tríceps na polia',pushups:'flexões',quad:'quadríceps',quadriceps:'quadríceps',raise:'elevação',raises:'elevações',rear:'posterior',resistance:'resistência',reverse:'inverso',romanian:'romeno',rope:'corda',rotation:'rotação',row:'remada',rows:'remadas',running:'corrida',seated:'sentado',shoulder:'ombro',shoulders:'ombros',shrug:'encolhimento',shrugs:'encolhimentos',side:'lateral',single:'único',sit:'abdominal',sled:'trenó',smith:'smith',snatch:'arranco',split:'dividido',squat:'agachamento',squats:'agachamentos',standing:'em pé',step:'passada',straight:'estendido',stretch:'alongamento',sumo:'sumô',supine:'supinado',suspended:'suspenso',swing:'balanço',swings:'balanços',thigh:'coxa',throw:'arremesso',tricep:'tríceps',triceps:'tríceps',twist:'rotação',twists:'rotações',upright:'vertical',upper:'superior',walking:'caminhando',wall:'parede',weighted:'com peso',wide:'aberta',wrist:'punho',with:'com',without:'sem',one:'um',two:'dois',the:'',of:'de',and:'e',on:'em',from:'a partir de',to:'para',up:'',version:'versão'};

function clean(value){return String(value||'').replaceAll('_',' ').replace(/\s+/g,' ').trim()}
function translated(value){const text=clean(value);if(!text)return 'Exercício';if(translations[text])return translations[text];let result=text.toLowerCase();Object.entries(phrases).sort((a,b)=>b[0].length-a[0].length).forEach(([source,target])=>{result=result.replace(new RegExp(`\\b${source}\\b`,'g'),target)});result=result.split(/(\s+|[-/()])/).map(part=>words[part]??part).join('').replace(/\s+/g,' ').replace(/\s+([/),-])/g,'$1').trim();return result.charAt(0).toUpperCase()+result.slice(1)}
...
function saved(){const source=readStore()?.exercises;if(!Array.isArray(source))return[];const seen=new Set();return source.filter(item=>{const type=clean(item?.type);if(!type||seen.has(type))return false;seen.add(type);return true})}
...
function enhanceAdminManager(){
  document.querySelectorAll('.exercise-picker .picker-item').forEach(row=>{
    ...
    const original=row.dataset.originalName||clean(title.textContent);const inputValue=String(input?.value||'');const type=inputValue&&inputValue!=='on'?inputValue:original;row.dataset.type=type;row.dataset.originalName=original;title.textContent=displayName(type,original);
...
function persistAdminNames(){const custom=readCustom();const store=readStore();if(!store||!Array.isArray(store.exercises))return;let changed=false;const exercises=store.exercises.map(item=>{const name=clean(custom[String(item.type)]||custom[clean(item.name)]);if(name&&name!==item.name){changed=true;return{...item,name}}return item});if(changed)writeStore({...store,exercises})}
...
function apply(){ensureStyle();enhanceStudentManager();enhanceAdminManager();translateVisible()}
...
document.addEventListener('click',event=>{if(event.target.closest?.('.exercise-picker .picker-footer .primary'))setTimeout(persistAdminNames,100)},true);
